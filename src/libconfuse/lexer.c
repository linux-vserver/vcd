#line 2 "../../../src/libconfuse/lexer.c"

#line 4 "../../../src/libconfuse/lexer.c"
...
char *cfg_yytext;
#line 1 "../../../src/libconfuse/lexer.l"
#line 2 "../../../src/libconfuse/lexer.l"
...
#line 613 "../../../src/libconfuse/lexer.c"
...
#line 79 "../../../src/libconfuse/lexer.l"


#line 772 "../../../src/libconfuse/lexer.c"
...
case 1:
YY_RULE_SETUP
#line 81 "../../../src/libconfuse/lexer.l"
/* eat up whitespace */
	YY_BREAK
case 2:
/* rule 2 can match eol */
YY_RULE_SETUP
#line 83 "../../../src/libconfuse/lexer.l"
cfg->line++; /* keep track of line number */
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 85 "../../../src/libconfuse/lexer.l"
...
case 4:
YY_RULE_SETUP
#line 89 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return '{'; }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 90 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return '}'; }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 91 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return '('; }
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 92 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return ')'; }
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 93 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return '='; }
	YY_BREAK
case 9:
YY_RULE_SETUP
#line 94 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return '+'; }
	YY_BREAK
case 10:
YY_RULE_SETUP
#line 95 "../../../src/libconfuse/lexer.l"
{ cfg_yylval = cfg_yytext; return ','; }
	YY_BREAK
...
case 11:
YY_RULE_SETUP
#line 99 "../../../src/libconfuse/lexer.l"
BEGIN(comment);
	YY_BREAK
case 12:
YY_RULE_SETUP
#line 100 "../../../src/libconfuse/lexer.l"
/* eat anything that's not a '*' */
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 101 "../../../src/libconfuse/lexer.l"
/* eat up '*'s not followed by '/'s */
	YY_BREAK
case 14:
/* rule 14 can match eol */
YY_RULE_SETUP
#line 102 "../../../src/libconfuse/lexer.l"
cfg->line++;
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 103 "../../../src/libconfuse/lexer.l"
BEGIN(INITIAL);
	YY_BREAK
...
case 16:
YY_RULE_SETUP
#line 107 "../../../src/libconfuse/lexer.l"
{
    qstring_index = 0;
    BEGIN(dq_str);
}
...
case 17:
YY_RULE_SETUP
#line 111 "../../../src/libconfuse/lexer.l"
...
YY_RULE_SETUP
#line 117 "../../../src/libconfuse/lexer.l"
...
YY_RULE_SETUP
#line 132 "../../../src/libconfuse/lexer.l"
{
    qputc('\n');
    cfg->line++;
}
...
YY_RULE_SETUP
#line 136 "../../../src/libconfuse/lexer.l"
...
case 21:
YY_RULE_SETUP
#line 140 "../../../src/libconfuse/lexer.l"
{  /* octal escape sequence */
    int result;
    sscanf(cfg_yytext + 1, "%o", (unsigned int *) &result);
    if(result > 0xFF) {
...
case 22:
YY_RULE_SETUP
#line 149 "../../../src/libconfuse/lexer.l"
{
...
case 23:
YY_RULE_SETUP
#line 153 "../../../src/libconfuse/lexer.l"
{ /* hexadecimal escape sequence */
    int result;
    sscanf(cfg_yytext + 2, "%x", (unsigned int *) &result);
    qputc(result);
}
	YY_BREAK
case 24:
YY_RULE_SETUP
#line 158 "../../../src/libconfuse/lexer.l"
{
    qputc('\n');
}
	YY_BREAK
case 25:
YY_RULE_SETUP
#line 161 "../../../src/libconfuse/lexer.l"
{
    qputc('\r');
}
	YY_BREAK
case 26:
YY_RULE_SETUP
#line 164 "../../../src/libconfuse/lexer.l"
{
    qputc('\b');
}
	YY_BREAK
case 27:
YY_RULE_SETUP
#line 167 "../../../src/libconfuse/lexer.l"
{
    qputc('\f');
}
	YY_BREAK
case 28:
YY_RULE_SETUP
#line 170 "../../../src/libconfuse/lexer.l"
{
    qputc('\007');
}
	YY_BREAK
case 29:
YY_RULE_SETUP
#line 173 "../../../src/libconfuse/lexer.l"
{
    qputc('\033');
}
	YY_BREAK
case 30:
YY_RULE_SETUP
#line 176 "../../../src/libconfuse/lexer.l"
{
    qputc('\t');
}
	YY_BREAK
case 31:
YY_RULE_SETUP
#line 179 "../../../src/libconfuse/lexer.l"
{
    qputc('\v');
}
	YY_BREAK
case 32:
YY_RULE_SETUP
#line 182 "../../../src/libconfuse/lexer.l"
{
    qputc(cfg_yytext[1]);
}
	YY_BREAK
case 33:
YY_RULE_SETUP
#line 185 "../../../src/libconfuse/lexer.l"
{
...
case 34:
YY_RULE_SETUP
#line 193 "../../../src/libconfuse/lexer.l"
{
    qstring_index = 0;
    BEGIN(sq_str);
}
...
case 35:
YY_RULE_SETUP
#line 197 "../../../src/libconfuse/lexer.l"
{ /* saw closing quote - all done */
    BEGIN(INITIAL);
    qputc('\0');
    cfg_yylval = cfg_qstring;
...
YY_RULE_SETUP
#line 203 "../../../src/libconfuse/lexer.l"
{
    qputc('\n');
    cfg->line++;
}
...
YY_RULE_SETUP
#line 207 "../../../src/libconfuse/lexer.l"
{ /* allow continuing on next line */
    /* no-op */
    cfg->line++;
}
...
case 38:
YY_RULE_SETUP
#line 211 "../../../src/libconfuse/lexer.l"
{
    qputc(cfg_yytext[1]);
}
	YY_BREAK
...
YY_RULE_SETUP
#line 214 "../../../src/libconfuse/lexer.l"
{
    qputc(cfg_yytext[0]);
    qputc(cfg_yytext[1]);
}
...
case 40:
YY_RULE_SETUP
#line 218 "../../../src/libconfuse/lexer.l"
{
    char *cp = cfg_yytext;
    while(*cp != '\0') {
        qputc(*cp++);
...
#line 224 "../../../src/libconfuse/lexer.l"
{
...
#line 229 "../../../src/libconfuse/lexer.l"
{
...
YY_RULE_SETUP
#line 249 "../../../src/libconfuse/lexer.l"
{
    char *var;
    char *e;
    cfg_yytext[strlen(cfg_yytext) - 1] = 0;
...
case 42:
YY_RULE_SETUP
#line 271 "../../../src/libconfuse/lexer.l"
{
...
case 43:
YY_RULE_SETUP
#line 276 "../../../src/libconfuse/lexer.l"
ECHO;
	YY_BREAK
#line 1229 "../../../src/libconfuse/lexer.c"
 ...
 */
YY_BUFFER_STATE cfg_yy_scan_string (yyconst char * __yystr )
{
    
	return cfg_yy_scan_bytes(__yystr,strlen(__yystr) );
}
