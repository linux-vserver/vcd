...
struct _single_node {
	...
	{ "net.addr",                "net/addr" },
	{ "sched.fillrate",          "sched/fillrate" },
	{ "sched.interval",          "sched/interval" },
	{ "sched.tokens",            "sched/tokens" },
	{ "sched.tokensmax",         "sched/tokensmax" },
	{ "sched.tokensmin",         "sched/tokensmin" },
	{ "sched.priobias",          "sched/priobias" },
