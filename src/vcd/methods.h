...
MPROTO(m_vg_list);
MPROTO(m_vg_remove);
MPROTO(m_vg_vx_reboot);
MPROTO(m_vg_vx_restart);
...
MPROTO(m_vx_exec);
MPROTO(m_vx_kill);
MPROTO(m_vx_limstatus);
MPROTO(m_vx_netstatus);
MPROTO(m_vx_reboot);
MPROTO(m_vx_remove);
MPROTO(m_vx_rename);
MPROTO(m_vx_restart);
...
MPROTO(m_vxdb_vx_cpuset_get);
MPROTO(m_vxdb_vx_cpuset_remove);
MPROTO(m_vxdb_vx_cpuset_set);
