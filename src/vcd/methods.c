...
m_err_t method_error_codes[] = {
	...
	{ MENOUSER,  "User does not exist" },
	{ MESTOPPED, "Virtual server not running" },
	{ MERUNNING, "Virtual server still/already running" },
	{ MEEXIST,   "Object already exists" },
	{ MENOVPS,   "Virtual server does not exist" },
	{ MENOVG,    "Virtual server group does not exist" },
