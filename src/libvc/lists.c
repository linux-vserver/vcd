...
/* inode attributes */
FLIST32_START(vc_iattr_list)
FLIST32_NODE(IATTR, XID)
...
FLIST64_START(vc_nflags_list)
FLIST64_NODE(NXF, STATE_SETUP)
FLIST64_NODE(NXF, SC_HELPER)
FLIST64_NODE(NXF, PERSISTANT)
FLIST64_END

/* scheduler option list */
FLIST32_START(vc_sched_list)
